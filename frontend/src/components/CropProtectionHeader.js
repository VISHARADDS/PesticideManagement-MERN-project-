          ...
          <div className="container-fluid px-0">
            ...
            <div className="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
              <ul className="navbar-nav navbar-nav-hover ms-auto">
                ...
                <li className="nav-item dropdown dropdown-hover mx-2">
                  <a  href="/cart"  className="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false" style={{fontSize:"18px"}}>
                    <i className="material-icons opacity-6 me-2 text-md">shop</i>
               Cart
                  </a>
